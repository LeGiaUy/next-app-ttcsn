...
import { CartProductType } from "../product/[productId]/ProdeucDetails";
...
const IteamContent: React.FC<ItemContentProps> = ({ item }) => {
        ...
        <div className="col-span-2 justify-self-start flex gap-2 md:gap-4">
            ...
            <div className="flex flex-col justify-between">
                ...
                <div className="w-[70px]">
                    <button className="text-slate-500 underline" onClick={() => {handleRemoveProductFromCart(item)}}>Xóa</button>
                </div>
            </div>
